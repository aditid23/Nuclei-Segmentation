...
# ===============================================================
# 1) Google Drive download & patched load
# ===============================================================
GDRIVE_FILE_ID = "139qMorO8YdWsfcfPdRTOMHforheaqq6q"
WEIGHTS_DIR = "model"
...
def load_model_from_gdrive():
    ...
    # Patch InputLayer batch_shape issue
    with h5py.File(WEIGHTS_PATH, 'r+') as f:
        if 'model_config' in f:
            config_bytes = f['model_config'][()]
            ...
            f['model_config'][()] = json.dumps(config).encode('utf-8')
